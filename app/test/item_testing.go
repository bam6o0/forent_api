...
func DeleteItemBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ItemController, payload *app.DeleteItemPayload) (http.ResponseWriter, error) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "ItemTest"), rw, req, prms)
	deleteCtx, __err := app.NewDeleteItemContext(goaCtx, req, service)
	if __err != nil {
		_e, _ok := __err.(goa.ServiceError)
		if !_ok {
			panic("invalid test data " + __err.Error()) // bug
...
// ListItemNotFound runs the method List of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListItemNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ItemController, payload *app.ListItemPayload) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
func UpdateItemBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ItemController, payload *app.UpdateItemPayload) (http.ResponseWriter, error) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "ItemTest"), rw, req, prms)
	updateCtx, __err := app.NewUpdateItemContext(goaCtx, req, service)
	if __err != nil {
		_e, _ok := __err.(goa.ServiceError)
		if !_ok {
			panic("invalid test data " + __err.Error()) // bug
